...
img<-antsImageRead('/data/jux/BBL/projects/pncNmf/results/CT/n1394_18CtNmfComponentsMerged.nii.gz',4)
...
antsImageWrite(newImg,"/data/jux/BBL/projects/pncNmf/tablesFigures/CtNmf18Components.nii.gz")
...
antsImageWrite(tvalMap,"/data/jux/BBL/projects/pncNmf/tablesFigures/CtNmfSignificantComponents.nii.gz")
