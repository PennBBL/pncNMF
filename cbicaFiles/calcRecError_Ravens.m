% read the data
mask_nii = load_untouch_nii('/cbica/projects/pncNmf/n1396_t1NMF/masks/n1396_ravensMask_thr01_2mm.nii.gz');
mask = mask_nii.img ;

data_lst = '/cbica/projects/pncNmf/n1396_t1NMF/subjectData/n1396_RavensPaths.csv';
...
resultsPath='/cbica/projects/pncNmf/n1396_t1NMF/results/Ravens/';
numBases=2:2:30;
...
% make figure
    ...
    set(gca,'fontsize',12)
    saveas(fig,'/cbica/projects/pncNmf/n1396_t1NMF/figures/reconstructionError_Ravens.png');
    ...
    saveas(fig2,'/cbica/projects/pncNmf/n1396_t1NMF/figures/reconstructionErrorGradient_Ravens.png');
    ...
    set(gca,'fontsize',12)
    saveas(fig3,'/cbica/projects/pncNmf/n1396_t1NMF/figures/percentageImprovementRecError_Ravens.png');
