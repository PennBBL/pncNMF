...
set(gca,'fontsize',12)
saveas(fig,'/cbica/projects/pncNmf/n1396_t1NMF/figures/MeanInnerProduct_Ravens.png');
...
set(gca,'fontsize',12)
saveas(fig2,'/cbica/projects/pncNmf/n1396_t1NMF/figures/MedianInnerProduct_Ravens.png');

fig3 = figure;plot(sortedBasisNum,ARI,'b','LineWidth',4)
axis([0 30 0 1])
xlabel('Number of components','fontsize',16)
ylabel({'Split-sample reproducibility' ;'(Adjusted Rand Index)'},'fontsize',16)
NumTicks = 16;
L = get(gca,'XLim');
set(gca,'fontsize',14,'box','off','XTick',linspace(L(1),L(2),NumTicks))
pbaspect([2 1 1])
saveas(fig3,'/cbica/projects/pncNmf/n1396_t1NMF/figures/AdjustedRandIndex_Ravens.png');
