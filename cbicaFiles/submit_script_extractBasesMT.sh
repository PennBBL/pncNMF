...
#$ -o /cbica/projects/pncNmf/n1396_t1NMF/results/CT/extractBasesMT.$JOB_ID.stdout
#### save the standard error:
#$ -e /cbica/projects/pncNmf/n1396_t1NMF/results/CT/extractBasesMT.$JOB_ID.stderr
####
#### My email address:
#$ -M {ADD YOUR EMAIL ADDRESS HERE]
...
/bin/echo "Command: /cbica/projects/pncNmf/n1396_t1NMF/scripts/extractBasesMT"
...
/bin/echo "Command: /cbica/projects/pncNmf/n1396_t1NMF/scripts/extractBasesMT" 1>&2
/bin/echo "Arguments: List of input files: $1 NumBases: $2 Output Directory: $3 mask: $4"
...
extractBasesMT=/cbica/projects/pncNmf/n1396_t1NMF/scripts/extractBasesMT
